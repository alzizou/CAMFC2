...
RECT_X(Each_station_period+2:Each_station_period+Time_pri+1,2) = Req_pos_pri*ones(Time_pri,1);
RECT_X(Each_station_period+Time_pri+2:2*Each_station_period+1,2) = Req_pos*ones(Each_station_period-Time_pri,1);
...
RECT_Y(2*Each_station_period+2:2*Each_station_period+Time_pri+1,2) = Req_pos_pri*ones(Time_pri,1);
RECT_Y(2*Each_station_period+Time_pri+2:3*Each_station_period+1,2) = Req_pos*ones(Each_station_period-Time_pri,1);
...
RECT_Z(1:Time_pri,2) = Req_pos_pri*ones(Time_pri,1);
RECT_Z(Time_pri+1:Each_station_period+1,2) = Req_pos*ones(Each_station_period-Time_pri+1,1);
